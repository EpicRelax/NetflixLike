...
class Film extends FilmRepository
{
    ...
    public function setId_movie($id_movie)
    {
        if (is_int($id_movie)) {
            ...
            throw new Exception("id_movie doit être de type int !");
        }
    }
    ...
    public function setTitle($title)
    {
        if (is_string($title)) {
            ...
            throw new Exception("title doit être de type string !");
        }
    }
    ...
    public function setYear($year)
    {
        if (is_int($year)) {
            ...
            throw new Exception("year doit être de type int !");
        }
    }
    ...
    public function setGenres($genres)
    {
        if (is_string($genres)) {
            ...
            throw new Exception("genres doit être de type string !");
        }
    }
    ...
    public function setDirectors($directors)
    {
        if (is_string($directors)) {
            ...
            throw new Exception("directors doit être de type string !");
        }
    }
    ...
    public function setCast($cast)
    {
        if (is_string($cast)) {
            ...
            throw new Exception("cast doit être de type string !");
        }
    }
}
